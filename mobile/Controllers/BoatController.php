...
class BoatController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Mobile boats index error: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function show(Boat $boat): JsonResponse
    {
        try {
            ...
            Log::error('Mobile boat show error: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function moveToMaintenance(Request $request, Boat $boat): JsonResponse
    {
        try {
            ...
            Log::error('Mobile maintenance error: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function removeFromMaintenance(Request $request, Boat $boat): JsonResponse
    {
        try {
            ...
            Log::error('Mobile remove maintenance error: ' . $e->getMessage());
            return response()->json([
                'success' => false,
